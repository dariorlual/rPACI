...
First, we assume a corneal dataframe is already available, which may have been obtained from the function `readCornealTopography` (see vignette entitled *Workflow of package rPACI*), using `simulateData` (see vignette entitled *Simulating corneal datasets*), or by other ways.
