...
The next example simulates three patient's measurements over time using the function `simulateData()` and the analyzes these files:
...
analyzeEvolution(data = system.file("extdata/temporal/", package="rPACI"), fileExtension = 'txt')
...
````{R, echo = F, eval = T, fig.width = 4, fig.height = 4}
library(DiagrammeR)
